...
object MainGridPaneUtils
    ...
    def buildNoteColumn(): TableColumn[Note, String] =
        ...
        noteColumn.setCellValueFactory(PropertyValueFactory[Note,String]("NoteShortened"))
        noteColumn
    ...
    def buildDateColumn(): TableColumn[Note, Date] =
        val dateColumn = TableColumn[Note, Date](DATE_HEADER)
        dateColumn.setMinWidth(150)
        dateColumn.setCellValueFactory(PropertyValueFactory[Note,Date]("DateUpdated"))
        dateColumn
    ...
    def configureTopHBoxGeometry(topHbox: HBox, searchField: TextField): Unit =
